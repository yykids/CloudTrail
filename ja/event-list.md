...
|イベント|イベントID|サービス|
| --- | --- | --- |
|スケーリンググループ予約作業の作成|event_id.iaas.autoscale_schedule.create|基本インフラサービス|
|スケーリンググループ予約作業の削除|event_id.iaas.autoscale_schedule.delete|基本インフラサービス|
...
|インスタンスFloating IP接続の解除|event_id.iaas.floating_ip.detach|基本インフラサービス|
...
|ロードバランサーインスタンス接続の追加|event_id.iaas.loadbalancer_member.create|基本インフラサービス|
|ロードバランサーインスタンス接続の解除|event_id.iaas.loadbalancer_member.delete|基本インフラサービス|
...
|ルーティングテーブルインターネットゲートウェイ接続の解除|event_id.iaas.routing_table.detach_gateway|基本インフラサービス|
...
|アカウントの照会|event_id.object_storage.account.lookup|Object Storage|
|アカウントメタデータの登録/修正|event_id.object_storage.account.metadata.update|Object Storage|
|コンテナリストの照会|event_id.object_storage.container.list_lookup|Object Storage|
|コンテナの照会|event_id.object_storage.container.lookup|Object Storage|
...
|オブジェクトリストの照会|event_id.object_storage.object.list_lookup|Object Storage|
...
|組織内部会員パスワード変更告知メールの送信|event_id.org.iam.member.send_mail|コンソール|
