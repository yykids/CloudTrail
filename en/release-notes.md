...
* Added events related to DNS Plus Service.
    * Refer to the manual for more details : [Link](/en/CloudTrail/en/event-list/)
...
* Updated, for the query of CloudTrail events, the search conditions of users who occurred events.
    * Refer to the manual for more details : [Link](/en/CloudTrail/en/api-guide/)

### Sept. 24, 2019 
#### More Features 
* Restul API is provided for query of events. 
    * See manual for more details: [Link](/en/CloudTrail/en/api-guide/)
